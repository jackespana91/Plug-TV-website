...
(each row = one outcome), RTP is exact by construction — every mode is 96.00%.
...
PAYTABLES = {
    "wedge":      [(0, 1362), (0.5, 2000), (0.8, 2200), (1, 2300), (1.5, 1200), (2, 650), (5, 288)],
    "short_iron": [(0, 2332), (0.2, 1500), (0.5, 1800), (0.8, 1400), (1, 1300), (2, 900), (3, 500), (10, 268)],
    "long_iron":  [(0, 3384), (0.2, 1400), (0.5, 1500), (0.8, 1100), (1, 1100), (2, 950), (5, 380), (15, 186)],
    "three_wood": [(0, 3939), (0.2, 1300), (0.5, 1300), (0.8, 1000), (1, 950), (2, 895), (5, 400), (10, 150), (25, 66)],
    "driver":     [(0, 4693), (0.2, 1200), (0.5, 1100), (0.8, 800), (1, 800), (2, 800), (5, 380), (10, 162), (25, 40), (50, 25)],
    "masters":    [(0, 6140), (0.5, 1500), (1, 1000), (2, 800), (5, 350), (10, 150), (25, 40), (100, 20)],
}
